...
<div class="card">
  <div class="card-header">
    ...
    <a href="/input" class="btn btn-success"><span class="fas fa-plus"></span>Tambah</a>
    @else
        ...
        @endphp
          ...
          <tr>
            <td>{{ ++$no }}</td> 
             ...
             <td>
              &nbsp
              <form method="post" action="user/delete/{{$gets->id}}"> 
             @csrf
              <input type="hidden" name="_method" value="DELETE">

              <a href="/user/edit/{{$gets->id}}" onclick="return confirm('Are you sure?')" class="btn btn-warning">Edit</a>
              @if ($gets->active == 0)
